...
public class  WeatherDate{
    private String solor_date = "";
    private String week = "";
    private String lunar_data = "";

    WeatherDate(String solor_date, String week, String lunar_data) {
        this.solor_date = solor_date;
        this.week = week;
        this.lunar_data = lunar_data;
    }
    WeatherDate(){

    }

    public void setSolor_date(String solor_date) {
        this.solor_date = solor_date;
    }

    public void setLunar_data(String lunar_data) {
        this.lunar_data = lunar_data;
    }
    ...
    public static WeatherDate getCurrentDate() {
        String []dayToChinese  ={"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十"
                                    ,"十一","十二","十三","十四","十五","十六","十七","十八","十九","二十"
                                    ,"廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"};
        String [] monthToChinese ={"正","二","三","四","五","六","七","八","九","十","冬","腊"};
        ...
        try {
          ...
          //  Log.w("test",connection.toString());
            connection.setRequestMethod("GET");
            connection.setConnectTimeout(8000);
            connection.setReadTimeout(8000);
            connection.setDoOutput(true);
            connection.setDoInput(true);
            long dateL = connection.getDate();

          //  Log.w("test",String.valueOf(dateL));
      ...
      //  Log.w("test",date.toString());
        ...
        String [] solor_date = sdf.format(date).split(" ");
        Log.w("Main",solor_date[4]);

        Solar solar = new Solar();
        solar.solarYear = Integer.parseInt(solor_date[0]);
        //解析月，处理01、02这种情况
        if(solor_date[1].charAt(0) == '0')
            solar.solarMonth = solor_date[1].charAt(1) - '0';
        else
            solar.solarMonth = Integer.parseInt(solor_date[1]);
        //解析天，处理01，02这种情况
        if(solor_date[2].charAt(0) == '0')
            solar.solarDay = solor_date[2].charAt(1) - '0';
        else
            solar.solarDay = Integer.parseInt(solor_date[2]);
        Lunar lunar = LunarSolarConverter.SolarToLunar(solar);
        WeatherDate weatherDate = new WeatherDate();
        weatherDate.setSolor_date(solor_date[1]+"月"+solor_date[2]+"日");
